...
score: 8.0
evidence: 并行智能体系统中通过选择性跨团队信息复用避免重复计算
tldr: 并行智能体系统需要多团队探索不同推理轨迹，但常对相似子问题重复计算，导致计算成本高。作者提出学习共享机制LTS，利用可学习的共享记忆在跨团队间选择性复用信息，同时控制上下文增长。实验表明该方法能显著减少冗余计算，提升并行智能体系统的效率。
source: ICML-2026-Accepted
selection_source: conference_retrieval
motivation: 多智能体并行执行时不同团队会对相似子问题重复计算，造成大量计算浪费。
method: 提出LTS，一种可学习的共享记忆机制，通过选择性跨团队信息复用并控制上下文增长。
result: 实验证明LTS能有效减少冗余计算，提升并行智能体系统的计算效率。
conclusion: 为并行智能体系统提供了一种信息复用的可学习方法，有助于降低多智能体协作的计算成本。
---
